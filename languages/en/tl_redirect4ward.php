...
$GLOBALS['TL_LANG']['tl_redirect4ward']['importLogs'][1] = "Import 404 logs of the last hour.";

$GLOBALS['TL_LANG']['tl_redirect4ward']['source'][0] = "Sitemap URL";
$GLOBALS['TL_LANG']['tl_redirect4ward']['source'][1] = "Sitemap URL.";

$GLOBALS['TL_LANG']['tl_redirect4ward']['addLogMessage'] = '%d new redirections from log.';

$GLOBALS['TL_LANG']['tl_redirect4ward']['addSitemapMessage'] = '%d new redirections from sitemap(<a href="%s">%s</a>).';
$GLOBALS['TL_LANG']['tl_redirect4ward']['addSitemapErrorMessage'] = 'Error while reading sitemap (<a href="%s">%s</a>.';
...
$GLOBALS['TL_LANG']['tl_redirect4ward']['new'] = array(
	'New redirection',
